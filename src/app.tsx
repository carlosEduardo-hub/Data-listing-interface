...
export function App() {
  ...
  const {data: tagsResponse,isLoading,isFetching,} = useQuery<TagResponse>({
    ...
    placeholderData: keepPreviousData, // Serve para não piscar a tela durante o tempo da requisição,o conteudo so retorna para a tela depois que a requisição é finalizada
  });
